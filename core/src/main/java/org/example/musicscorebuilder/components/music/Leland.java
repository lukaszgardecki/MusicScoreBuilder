...
public enum Leland {
    ...
    ACC_FLAT("\uE260", 0.812, 1.812, 0.0, -0.704),
    ACC_NATURAL("\uE261", 0.684, 1.3, 0.0, -1.292),
    ACC_SHARP("\uE262", 0.976, 1.336, 0.0, -1.332),
    ACC_DOUBLE_SHARP("\uE263", 1.1, 0.552, 0.0, -0.548),
    ACC_DOUBLE_FLAT("\uE264", 1.484, 1.812, 0.0, -0.704),
